...
function uncss(src) {
    ...
    var options = {
        indexCssName: 'desktop.bundles/index/index.css',
        levelPrefix: function(n) {
            return 'level-' + n + '.blocks';
        }
    };
    ...
    function level(path) {
        return PATH.join(options.levelPrefix((levels[path] || '0')), path);
    }
